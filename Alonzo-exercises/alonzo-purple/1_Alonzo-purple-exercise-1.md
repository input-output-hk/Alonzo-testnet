...
- Make sure you can access:
	...
	2. The Alonzo Purple Testnet configuration (see main README.md)
	3. Either, the correct binary image for your operating system, or the Docker image (see main README.md).
